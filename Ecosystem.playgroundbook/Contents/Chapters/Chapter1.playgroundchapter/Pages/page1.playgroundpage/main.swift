/*:
 ...
 - callout(João): Hey! I'm glad you're here! You want to know more about ecosystems? That's great!

+ callout(João): Shortly you will learn all about how an ecosystem works, from the importance of plants all the way to carnivores. We will build and *try* to simulate our own ecosystem too! But if things go wrong, I won't take responsibility...
 ...
 * callout(WWDC): 🙄
 ...
 ### What is an ecosystem and why should I even care?
   ...
   According to the professor of Biology Lana Magalhães, ecosystem is a set of living organisms that live and interact with each other and with the environment, constituting a stable, balanced and self-sufficient system.\
    That being said, I bet you already saw one! In fact, **you live in an ecosystem!** It might be different from mine or from someone across your country, there're plenty of them on the planet, all having different sizes and locations. It's basically our home, but in a larger scale... I think you get the importance 😊 \
 ...
 - Note: All info here will be very summarized to be fast to read while also talking about important points. The objective here is to motivate you to search and learn more on your own.
